...
function do_gestalt(val,val2){var ix;switch(val){case 0:return 0x00030102;case 1:return 0x00020108;case 2:return 1;case 3:return 1;case 4:switch(val2){case 0:return 1;case 1:return 1;case 2:return 1;default:return 0;}
...
image_format='array';all_options.io=window.Glk;all_options.vm=window.Quixe;all_options.GiLoad=this;all_options.GlkOte=new window.GlkOteClass();all_options.GiDispa=new window.GiDispaClass();GlkOte=all_options.GlkOte;if(!optobj)
