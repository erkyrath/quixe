...
xo_table=Array(4);seed=(seed>>>0);for(ix=0;ix<4;ix++){seed=(seed+0x9E3779B9)>>>0;s=seed;s=(s^(s>>>15))>>>0;s=Math.imul(s,0x85EBCA6B)>>>0;s=(s^(s>>>13))>>>0;s=Math.imul(s,0xC2B2AE35)>>>0;s=(s^(s>>>16))>>>0;xo_table[ix]=s>>>0;}}
function xo_get_random(){var t1x5=Math.imul(xo_table[1],5)>>>0;var result=Math.imul(((t1x5<<7)|(t1x5>>>(32-7))),9)>>>0;var t1s9=(xo_table[1]<<9)>>>0;xo_table[2]=(xo_table[2]^xo_table[0])>>>0;xo_table[3]=(xo_table[3]^xo_table[1])>>>0;xo_table[1]=(xo_table[1]^xo_table[2])>>>0;xo_table[0]=(xo_table[0]^xo_table[3])>>>0;xo_table[2]=(xo_table[2]^t1s9)>>>0;var t3=xo_table[3];xo_table[3]=((t3<<11)|(t3>>>(32-11)))>>>0;return result>>>0;}
