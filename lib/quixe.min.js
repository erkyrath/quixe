...
if(optobj){jQuery.extend(all_options,optobj);}
...
GlkOte=all_options.GlkOte;if(all_options.resources!=undefined){if(jQuery.type(all_options.resources)==='string'){if(window[all_options.resources])
all_options.resources=window[all_options.resources];else
delete all_options.resources;}}
if(all_options.image_info_map!=undefined){if(jQuery.type(all_options.image_info_map)==='string'){if(window[all_options.image_info_map])
