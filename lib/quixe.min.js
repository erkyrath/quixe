...
val="0"+val;ls[ix]=val;}
game_signature=ls.join('');if(all_options){opt_rethrow_exceptions=all_options.rethrow_exceptions;opt_do_vm_autosave=all_options.do_vm_autosave;opt_clear_vm_autosave=all_options.clear_vm_autosave;opt_before_vm_autosave=all_options.before_vm_autosave;}
...
function do_gestalt(val,val2){var ix;switch(val){case 0:return 0x00030102;case 1:return 0x00020104;case 2:return 1;case 3:return 1;case 4:switch(val2){case 0:return 1;case 1:return 1;case 2:return 1;default:return 0;}
...
function vm_autosave(eventaddr){if(opt_before_vm_autosave){try{opt_before_vm_autosave(self);}
catch(ex){};}
if(eventaddr<0){Dialog.autosave_write(game_signature,null);return;}
