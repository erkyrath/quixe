...
image_format='array';all_options.io=window.Glk;all_options.vm=window.Quixe;all_options.GiLoad=this;all_options.GlkOte=new window.GlkOteClass();if(window.GiDispaClass){all_options.GiDispa=new window.GiDispaClass();}
