...
self.vm_save=vm_save;self.vm_restore=vm_restore;self.vm_saveundo=vm_saveundo;self.vm_restoreundo=vm_restoreundo;self.vm_hasundo=vm_hasundo;self.vm_discardundo=vm_discardundo;function change_memsize(newlen,internal){var lx;if(newlen==self.endmem)
