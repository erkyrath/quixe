...
image_format='array';all_options.io=window.Glk;switch(imageoptions.engine){case'quixe':case null:case undefined:all_options.engine_name='Quixe';all_options.blorb_gamechunk_type='GLUL';all_options.game_format_name='Glulx';all_options.vm=window.Quixe;break;case'ifvms':all_options.engine_name='IFVMS';all_options.blorb_gamechunk_type='ZCOD';all_options.game_format_name='Z-code';all_options.vm=window.engine=new window.ZVM();all_options.Glk=window.Glk;break;default:all_options.io.fatal_error("Engine not recognized: "+imageoptions.engine);return;}
if(!optobj)
