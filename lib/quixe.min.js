...
var script=$('<script>',{src:gameurl,'type':"text/javascript"});headls[0].insert(script);return;}
...
var script=$('<script>',{src:fullurl,'type':"text/javascript"});headls[0].insert(script);return;}
