...
return;gli_selectref.set_field(0,Const.evtype_Mouse);gli_selectref.set_field(1,win);gli_selectref.set_field(2,xpos);gli_selectref.set_field(3,ypos);win.mouse_request=false;if(window.GiDispa)
GiDispa.prepare_resume(gli_selectref);gli_selectref=null;VM.resume();}
...
throw('glk_request_mouse_event: invalid window');if(win.mouse_request)
throw('glk_request_mouse_event: window already has mouse request');if(win.type==Const.wintype_TextGrid||win.type==Const.wintype_Graphics){win.mouse_request=true;}}
