...
function accept_inputset(arg){var hasinput={};var hashyperlink={};jQuery.map(arg,function(argi){if(argi.type)
hasinput[argi.id]=argi;if(argi.hyperlink)
hashyperlink[argi.id]=true;});jQuery.each(windowdic,function(tmpid,win){win.reqhyperlink=hashyperlink[win.id];var argi=hasinput[win.id];if(argi==null)
