...
else if(el.blorbusage=='Data'){el.usage='data';}
else{el.usage='????';}
...
return null;var isbinary=false;if(chunk.blorbtype=='FORM')
isbinary=true;return{data:chunk.content,type:chunk.type,binary:isbinary};}
