...
return{version:'2.1.1',init:glkote_init,update:glkote_update,extevent:glkote_extevent,getinterface:glkote_get_interface,getdomcontext:glkote_get_dom_context,setdomcontext:glkote_set_dom_context,log:glkote_log,warning:glkote_warning,error:glkote_error};}();Dialog=function(){const fs=require('fs');const path_mod=require('path');const buffer_mod=require('buffer');var userpath=require('electron').remote.app.getPath('userData');var extfilepath=path_mod.join(userpath,'quixe-files');try{fs.mkdirSync(extfilepath);}
catch(ex){}
