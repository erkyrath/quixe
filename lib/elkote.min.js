...
if(heightrule==Const.imagerule_AspectRatio){heightrule=Const.imagerule_WidthFixed;var aspect=(info.height/info.width);height=width*aspect*(height/0x10000);}
if(maxwidth&&width>maxwidth*win.graphwidth){var aspect=(height/width);width=maxwidth*win.graphwidth;height=width*aspect;}}
