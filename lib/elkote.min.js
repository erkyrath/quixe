...
return{classname:'Dialog (ElectroFS)',version:'2.3.5',streaming:true,init_async:init_async,inited:dialog_inited,getlibrary:dialog_get_library,open:dialog_open,file_clean_fixed_name:file_clean_fixed_name,file_construct_ref:file_construct_ref,file_construct_temp_ref:file_construct_temp_ref,file_ref_exists:file_ref_exists,file_remove_ref:file_remove_ref,file_fopen:file_fopen,file_write:file_write,file_read:file_read,autosave_write:autosave_write,autosave_read:autosave_read};};var Dialog=new DialogClass();try{exports.Dialog=Dialog;exports.DialogClass=DialogClass;}catch(ex){};'use strict';var BlorbClass=function(){var inited=false;var metadata={};var coverimageres=undefined;var debug_info=null;var blorbchunks={};function blorb_init(data,opts){if(inited){throw new Error('Blorb: already inited');}
