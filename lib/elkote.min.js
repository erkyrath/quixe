...
function glkote_get_library(val){switch(val){case'Dialog':return Dialog;}
return null;}
...
return{streaming:true,init_async:init_async,inited:dialog_inited,open:dialog_open,file_clean_fixed_name:file_clean_fixed_name,file_construct_ref:file_construct_ref,file_construct_temp_ref:file_construct_temp_ref,file_ref_exists:file_ref_exists,file_remove_ref:file_remove_ref,file_fopen:file_fopen,file_write:file_write,file_read:file_read,autosave_write:autosave_write,autosave_read:autosave_read};};var Dialog=new DialogClass();try{exports.Dialog=Dialog;exports.DialogClass=DialogClass;}catch(ex){};'use strict';var Glk=function(){var VM=null;var has_canvas;var option_exit_warning;var option_do_vm_autosave;var option_before_select_hook;var option_extevent_hook;var option_glk_gestalt_hook;var has_exited=false;var ui_disabled=false;var ui_specialinput=null;var ui_specialcallback=null;var event_generation=0;var current_partial_inputs=null;var current_partial_outputs=null;function init(vm_options){has_canvas=(document.createElement('canvas').getContext!=undefined);VM=vm_options.vm;if(window.GiDispa)
...
function glk_fileref_create_temp(usage,rock){var filetype=(usage&Const.fileusage_TypeMask);var filetypename=FileTypeMap[filetype];var ref=Dialog.file_construct_temp_ref(filetypename);var fref=gli_new_fileref(ref.filename,usage,rock,ref);return fref;}
function glk_fileref_create_by_name(usage,filename,rock){filename=Dialog.file_clean_fixed_name(filename,(usage&Const.fileusage_TypeMask));var fref=gli_new_fileref(filename,usage,rock,null);return fref;}
