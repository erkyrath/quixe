...
var ram=snapshot.ram;snapshot.ram=undefined;var str=JSON.stringify(snapshot);fs.writeFileSync(pathj,str,{encoding:'utf8'});if(ram){var buf=new buffer_mod.Buffer(ram);fs.writeFileSync(pathr,buf);}}
