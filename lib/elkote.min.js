...
const divel=buffer_last_line(win);if(divel){const cursel=$('<span>',{id:dom_prefix+'win'+win.id+'_cursor','class':'InvisibleCursor'});divel.append(cursel);if(win.inputel){const inputel=win.inputel;const pos=cursel.position();let width=win.frameel.width()-(current_metrics.buffermarginx+pos.left+2);if(width<inputel_minwidth)
width=inputel_minwidth;inputel.css({width:width+'px'});cursel.append(inputel);}}}
...
const pos=cursel.position();let width=win.frameel.width()-(current_metrics.buffermarginx+pos.left+2);if(width<inputel_minwidth)
width=inputel_minwidth;inputel.css({width:width+'px'});if(newinputel)
