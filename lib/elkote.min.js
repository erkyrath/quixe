...
val2=res.val2;console.log('### external input: res=',res.type,val1,val2);gli_selectref.set_field(0,res.type);gli_selectref.set_field(1,null);gli_selectref.set_field(2,val1);gli_selectref.set_field(3,val2);if(window.GiDispa)
GiDispa.prepare_resume(gli_selectref);gli_selectref=null;VM.resume();}
