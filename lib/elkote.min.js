...
else if(el.blorbusage=='Data'){el.usage='data';el.binary=false;if(el.blorbtype=='FORM')
el.binary=true;}
else{el.usage='????';}
...
function get_chunk(usage,num){var chunk=blorbchunks[usage+':'+val];if(!chunk){return null;}
return chunk;}
