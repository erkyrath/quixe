...
return{streaming:true,open:dialog_open,file_clean_fixed_name:file_clean_fixed_name,file_construct_ref:file_construct_ref,file_construct_temp_ref:file_construct_temp_ref,file_ref_exists:file_ref_exists,file_remove_ref:file_remove_ref,file_fopen:file_fopen,file_write:file_write,file_read:file_read,autosave_write:autosave_write,autosave_read:autosave_read};}();Glk=function(){var VM=null;var has_canvas;var option_exit_warning;var option_do_vm_autosave;var option_before_select_hook;var has_exited=false;var ui_disabled=false;var ui_specialinput=null;var ui_specialcallback=null;var event_generation=0;var current_partial_inputs=null;var current_partial_outputs=null;function init(vm_options){has_canvas=(document.createElement('canvas').getContext!=undefined);VM=vm_options.vm;if(window.GiDispa)
GiDispa.set_vm(VM);vm_options.accept=accept_ui_event;GlkOte.init(vm_options);option_exit_warning=vm_options.exit_warning;option_do_vm_autosave=vm_options.do_vm_autosave;option_before_select_hook=vm_options.before_select_hook;if(option_before_select_hook){option_before_select_hook();}}
