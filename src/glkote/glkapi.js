...
8104, 8105, 8106, 8107, 8108, 8109, 8110, 8111,
  ...
  for (ix=0; ix<48; ix++) {
    val = ls[ix];
    unicode_title_table[ix+8064] = val;
  }
})();
...
[100,780],
  ...
  for (ix=0; ix<17; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+255] = val;
  }
  ls = [
...
[71,807], [103,807], [72,770], [104,770],
  ...
  for (ix=0; ix<20; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+274] = val;
  }
  ls = [
...
[84,780], [116,780],
  ...
  for (ix=0; ix<18; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+340] = val;
  }
  ls = [
...
[89,776], [90,769], [122,769], [90,775], [122,775], [90,780], [122,780],
  ...
  for (ix=0; ix<23; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+360] = val;
  }
  ls = [
...
[85,776,772], [117,776,772], [85,776,769], [117,776,769], [85,776,780], [117,776,780], [85,776,768], [117,776,768],
  ...
  for (ix=0; ix<16; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+461] = val;
  }
  ls = [
...
[83,806], [115,806], [84,806], [116,806],
  ...
  for (ix=0; ix<36; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+504] = val;
  }
  ls = [
...
[119,778], [121,778],
  ...
  for (ix=0; ix<154; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+7680] = val;
  }
  ls = [
...
[89,771], [121,771],
  ...
  for (ix=0; ix<90; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+7840] = val;
  }
  ls = [
...
[949,787], [949,788], [949,787,768], [949,788,768], [949,787,769], [949,788,769],
  ...
  for (ix=0; ix<22; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+7936] = val;
  }
  ls = [
...
[959,787], [959,788], [959,787,768], [959,788,768], [959,787,769], [959,788,769],
  ...
  for (ix=0; ix<38; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+7968] = val;
  }
  ls = [
...
[953,769], [959,768], [959,769], [965,768], [965,769], [969,768], [969,769],
  ...
  for (ix=0; ix<31; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+8031] = val;
  }
  ls = [
...
[945,774], [945,772], [945,768,837], [945,837], [945,769,837],
  ...
  for (ix=0; ix<53; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+8064] = val;
  }
  ls = [
...
[168,768], [168,769], [96],
  ...
  for (ix=0; ix<19; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+8157] = val;
  }
  ls = [
...
[34892], [38477], [35211], [24275], [20800], [21952],
  ...
  for (ix=0; ix<270; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+63744] = val;
  }
  ls = [
...
[38627], [38911], [38971],
  ...
  for (ix=0; ix<59; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+64048] = val;
  }
  ls = [
...
[40702], [40709], [40719], [40726], [40763], [173568],
  ...
  for (ix=0; ix<542; ix++) {
    val = ls[ix];
    unicode_decomp_table[ix+194560] = val;
  }
})();
